...
Write-Host 'Local headless runtime startup is deprecated.' -ForegroundColor Yellow
Write-Host 'Current architecture is MT5 EA -> Railway only.' -ForegroundColor Yellow
Write-Host 'Stopping any stray local runtime processes instead...' -ForegroundColor Cyan
...
Write-Host 'Cleanup complete. No local relay, supervisor, or scheduler was started.' -ForegroundColor Green
